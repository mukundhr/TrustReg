...
Because the objective of this project was to validate governance mechanisms rather than benchmark model performance at scale, 1.5k samples provided sufficient signal while enabling rapid iteration and keeping total cloud cost under ₹35 (~$0.38).
